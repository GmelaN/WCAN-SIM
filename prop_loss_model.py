...
from ban_seoung_sim.base.tools import Angles, Vector
import math
...
class PropLossModel(LossModel):
    ...
    def cal_path_loss(self, model1: MobilityModel, model2: MobilityModel) -> float:
    ...
    def calc_rx_power_friis(self, tx_power_dbm: float, a: MobilityModel, b: MobilityModel) -> float:
        distance = a.get_distance_from(b.get_position())

        if self.m_lambda == None:
